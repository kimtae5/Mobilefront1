            ...
            public void onClick(View v) {
                ...
                new Thread(){
                    public void run(){
                        try{
                            //URL생성
                            URL url = new URL("http://192.168.10.159:80/member/login");
                            //연결객체 생성
                            ...
                            //파일 업로드가 없는 POST방식에서의 파라미터 생성(email,password)
                            ...
                            if(error.equals("null")){
                                ...
                                //개인 정보를 파일에 저장 - 이 정보가 있으면 로그인을 한 것이고
                                //없으면 로그인을 안한것
                                ...
                                try{
                                    ...
                                    if(location != null){
                                        ...
                                        //서버에게 전송
                                        url = new URL("http://192.168.10.159:80/logininfo/location?"
                                    ...
                                    Log.e("위치정보사용오류", e.getLocalizedMessage());
                                }
